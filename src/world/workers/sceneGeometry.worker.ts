    ...
    (async () => {
        try {
            ...
            const shapeTargets: Record<SceneMorphTargetKey, Float32Array> = {
                name: createTextMorphPositions(regularFont, 'MANINDER SINGH', cloudPositions),
                ...
                certifications: createTextMorphPositions(
                    regularFont,
                    'CERTIFICATIONS',
                    cloudPositions,
                ),
                skills: createTextMorphPositions(regularFont, 'SKILLS', cloudPositions),
            ...
            const ellipsisTargets: SceneGeometryData['ellipsisTargets'] = {
                ...
                certifications: createTopDownGalaxyParticlePositions(ellipsisCount, 33, 5, 37),
                skills: createTopDownGalaxyParticlePositions(ellipsisCount, 33, 5, 37),
