...
export class SelectiveBloomSystem {
    ...
    public render(state: TextBloomState): void {
        ...
        const textStrength = bloomActive ? presence * 0.22 * scaleBloom * strengthScale : 0;
        ...
        if (material?.uniforms.uBloomStrength) {
            material.uniforms.uBloomStrength.value = 0.012 * strengthScale;
        }
        if (material?.uniforms.uHazeStrength) {
            material.uniforms.uHazeStrength.value = 0.025 * strengthScale;
        }
