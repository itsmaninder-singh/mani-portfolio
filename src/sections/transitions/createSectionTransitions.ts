...
export const createSectionTransitions = ({
    ...
    const handleExperience = (progress: number, _eased: number): void => {
        ...
        if (progress < experienceTransition.educationStart) {
        ...
        } else if (progress < experienceTransition.certificationStart) {
            world.morphToShape(
                'experience',
                'education',
                rangeProgress(
            ...
            world.morphToShape(
                ...
                rangeProgress(
                    progress,
                    experienceTransition.certificationStart,
                    experienceTransition.certificationEnd,
                ),
            );
        }
    };

    const handleStack = (progress: number, _eased: number): void => {
        world.morphToShape('certifications', 'skills', rangeProgress(progress, 0, 0.25));
    };
